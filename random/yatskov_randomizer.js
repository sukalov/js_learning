...
//   let text = document.querySelector('.text');
  ...
  if (words.length > 0 && lastWord !== (words[randomIndex])) {
    ...
    usedWords.splice(usedWords.length, 0, words[randomIndex]); // копируем использованное слово в свой массив
...
setInterval(() => updateText(), 100); // повторяем обновление текста очень часто
